    ...
    while (tok != NULL) {
      if (strcmp(tok, "sbc") == 0) {
        ...
        offload_codec_support[BTAV_A2DP_CODEC_INDEX_SOURCE_LDAC] = true;
          ...
          LOG_INFO( "%s: LHDCV3 offload supported", __func__);
          offload_codec_support[BTAV_A2DP_CODEC_INDEX_SOURCE_LHDCV3] = true;
      } else if (strcmp(tok, "lhdcv2") == 0) {
          LOG_INFO( "%s: LHDCV2 offload supported", __func__);
          offload_codec_support[BTAV_A2DP_CODEC_INDEX_SOURCE_LHDCV2] = true;
      } else if (strcmp(tok, "lhdcv1") == 0) {
          LOG_INFO( "%s: LHDCV1 offload supported", __func__);
          offload_codec_support[BTAV_A2DP_CODEC_INDEX_SOURCE_LHDCV1] = true;
#endif
      }
